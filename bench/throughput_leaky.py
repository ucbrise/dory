...
def runExperimentRound(numClusters):
    ...
    f91 = open("out/dory_leaky_throughput_" + str(numClusters) + "_9_1.dat", "w")
    f55 = open("out/dory_leaky_throughput_" + str(numClusters) + "_5_5.dat", "w")
    f19 = open("out/dory_leaky_throughput_" + str(numClusters) + "_1_9.dat", "w")
